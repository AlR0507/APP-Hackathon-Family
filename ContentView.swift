...
enum DataStore {
    ...
    // === Croquis interno del BBVA (aproximado, ampliado) ===
    static func bbvaBanos() -> [DetalleUbicacion] {
        [
            // Anillo bajo – Oriente / Poniente
            .init(numero: "1", tipo: .banos, titulo: "Anillo Bajo Oriente",
            ...
            .init(numero: "2", tipo: .banos, titulo: "Anillo Bajo Poniente",
            ...
            // Cabeceras
            .init(numero: "3", tipo: .banos, titulo: "Cabecera Norte",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "4", tipo: .banos, titulo: "Cabecera Sur",
            ...
            // Intermedios (mezzanine) – esquinas
            .init(numero: "5", tipo: .banos, titulo: "Esquina NE (Mezzanine)",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "6", tipo: .banos, titulo: "Esquina NO (Mezzanine)",
            ...
            // Nivel club/premium aproximados
            .init(numero: "7", tipo: .banos, titulo: "Zona Club Oriente",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "8", tipo: .banos, titulo: "Zona Club Poniente",
    ...
    static func bbvaAccesos() -> [DetalleUbicacion] {
        [
            // Rampas accesibles
            .init(numero: "A", tipo: .accesos, titulo: "Rampa Oriente",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "B", tipo: .accesos, titulo: "Rampa Poniente",
            ...
            // Túneles principales
            .init(numero: "C", tipo: .accesos, titulo: "Túnel Sur Principal",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "D", tipo: .accesos, titulo: "Túnel Norte",
            ...
            // Puertas laterales
            .init(numero: "E", tipo: .accesos, titulo: "Puerta Lateral SE",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "F", tipo: .accesos, titulo: "Puerta Lateral SO",
    ...
    static func bbvaPrimerosAuxilios() -> [DetalleUbicacion] {
        [
            .init(numero: "M1", tipo: .primerosAuxilios, titulo: "Módulo Médico Sur",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "M2", tipo: .primerosAuxilios, titulo: "Módulo Médico Oriente",
                  ...
                  coordinate: estadioBBVA),
            .init(numero: "M3", tipo: .primerosAuxilios, titulo: "Módulo Médico Poniente",
                  descripcion: "Apoyo médico lado poniente.",
                  informacionAdicional: ["Puesto temporal", "Lado Poniente"],
                  servicios: ["Primeros auxilios"],
                  puntoCroquis: CGPoint(x: -112, y: -8),
                  coordinate: estadioBBVA),
            .init(numero: "M4", tipo: .primerosAuxilios, titulo: "Punto de Respuesta Norte",
    ...
    static func bbvaLactancia() -> [DetalleUbicacion] {
        [
            .init(numero: "L1", tipo: .lactancia, titulo: "Sala Lactancia Oriente",
        ...
        ZStack {
            ...
            VStack(spacing: 14) {
                ...
                ZStack {
                    ...
                    HStack {
                        Button { mostrarMapaExterior = true } label: {
...
struct MapaExteriorView: View {
    ...
    // Navegación / UI
    @State private var mostrarCroquisAzteca = false
    @State private var mostrarCroquisBBVA   = false
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
                            ...
                            EstadioAnnotationView(title: place.title)
                                ...
                                .onTapGesture {
                                    if place.title == "Estadio Azteca" {
                                        mostrarCroquisAzteca = true
                                    } else {
                                        mostrarCroquisBBVA = true
                                    }
                                }
                                .id("estadio-\(place.id)")
            ...
            // === 3) Panel lateral izquierdo (estadios) ===
            ...
            // === 4) Panel lateral derecho (lista de servicios dinámicos) ===
            ...
            BottomPillBar(
                ...
                onHome: {
                    withAnimation { region.center = DataStore.estadioAzteca }
                },
                onStore: {
                    withAnimation(.spring(response: 0.4, dampingFraction: 0.85)) {
        ...
        // === Sheets y covers mínimos ===
        .fullScreenCover(isPresented: $mostrarCroquisAzteca) { AztecaCroquisView() }
        .fullScreenCover(isPresented: $mostrarCroquisBBVA) { BBVACroquisView() }
